    ...
    <div class="main_1">
        <div class="aboutUs">
            ...
            <p>В клубе есть благотворительный расчетный счет. Реквизиты счета <a
                        href="http://ttgomel/index.php?page=contacts" title="Перейти на страницу Контакты">здесь.</a></p>
        </div>
        ...
        <div class="newsShort">
            ...
            if ($result) {
                ...
                for ($i = 0; $i < $rows; ++$i) {
                    ...
                    //  print_r($row);
                    echo "<a href='http://ttgomel/index.php?page=fullNews&id=$row[2]' title='Перейти на страницу новости'>";
    ...
    <div class="main_3">
        <div class="tourney">
            ...
            <p> В спортивном зале СК "Гомсельмаш" проводится большое количество турниров разного уровня подготовленности
                ...
                <a href="http://ttgomel/index.php?page=calendar" title="Перейти на страницу Календарь">календарь турниров</a>). Система
                организации
                ...
                профессиональные турниры обсчитываются. Рейтинг клуба СК "Гомсельмаш" можно посмотреть <a
                        href="http://ttgomel/index.php?page=rating" title="Перейти на страницу Рейтинг">здесь</a>. Каждый,
                кто
        ...
        <div class="inventory">
            ...
            <p> На рынке существует большое количество ведущих мировых производителей инвентаря по настольному теннису:
                ...
                инвентарь, оказать квалифицированную консультацию вам помогут наши тренера (см. <a
                        href="http://ttgomel/index.php?page=contacts" title="Перейти на страницу Контакты">контакты</a>) – бесплатно!
            </p>
        </div>
    </div>
