    ...
    <div class='news'>
        ...
        for ($i = $startNewsOnPage;
            ...
            <div class='news_item'>
                ...
                <div class='titleNews'>
                    <a href='http://ttgomel/index.php?page=fullNews&id=<?php echo $row[0] ?>'
                       class='titleNews'><?php echo $row[1] ?></a>
                </div>
    ...
    <div class='pages'> Страница:
        <?php for ($i = 1; $i <= $pages; ++$i) {
            if ($i == (($startNewsOnPage / $countNewsOnPage) + 1)) {
                ?>
                <a href='http://ttgomel/index.php?page=news&startPage=<?php echo $i ?>'
                   class='currentPage'>&laquo; <?php echo $i ?> &raquo;</a>
            <?php } else { ?>
                <a href='http://ttgomel/index.php?page=news&startPage=<?php echo $i ?>'><?php echo $i ?></a>
                <?php
            }
        } ?>
